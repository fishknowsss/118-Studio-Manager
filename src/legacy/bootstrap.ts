...
async function seedDemoData() {
  ...
  const scheduleEntries: ClassScheduleEntry[] = [
    ...
    { id: uid(), personId: alice.id, personName: alice.name || '', className: '数媒 2201', courseName: '数字调色基础', dayOfWeek: 3, startSection: 5, endSection: 6, weeksText: '1-12周', location: '影像实验室', teacher: '许老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: bob.id, personName: bob.name || '', className: '动画 2201', courseName: '三维动画设计', dayOfWeek: 2, startSection: 3, endSection: 5, weeksText: '1-16周', location: '动画机房 B', teacher: '周老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: bob.id, personName: bob.name || '', className: '动画 2201', courseName: '动态图形', dayOfWeek: 5, startSection: 7, endSection: 8, weeksText: '1-10周', location: '艺设楼 402', teacher: '马老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: carol.id, personName: carol.name || '', className: '视传 2302', courseName: '品牌视觉系统', dayOfWeek: 1, startSection: 5, endSection: 7, weeksText: '1-16周', location: '设计楼 210', teacher: '钱老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: david.id, personName: david.name || '', className: david.className || '', courseName: '摄影棚实践', dayOfWeek: 4, startSection: 1, endSection: 4, weeksText: '1-14周', location: '摄影棚 1', teacher: '郑老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: emma.id, personName: emma.name || '', className: emma.className || '', courseName: '新媒体脚本写作', dayOfWeek: 2, startSection: 7, endSection: 8, weeksText: '1-16周', location: '文创楼 106', teacher: '韩老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: frank.id, personName: frank.name || '', className: frank.className || '', courseName: '角色绑定', dayOfWeek: 3, startSection: 1, endSection: 4, weeksText: '3-14周', location: '动画机房 A', teacher: '冯老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: grace.id, personName: grace.name || '', className: grace.className || '', courseName: '制片管理', dayOfWeek: 4, startSection: 7, endSection: 9, weeksText: '1-16周', location: '传媒楼 203', teacher: '李老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: he.id, personName: he.name || '', className: he.className || '', courseName: '同期录音', dayOfWeek: 5, startSection: 1, endSection: 3, weeksText: '1-12周', location: '录音棚', teacher: '顾老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: iris.id, personName: iris.name || '', className: iris.className || '', courseName: '字体设计', dayOfWeek: 2, startSection: 1, endSection: 2, weeksText: '1-16周', location: '设计楼 318', teacher: '赵老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
    { id: uid(), personId: jay.id, personName: jay.name || '', className: jay.className || '', courseName: '交互原型设计', dayOfWeek: 3, startSection: 7, endSection: 9, weeksText: '1-16周', location: '数媒实验室', teacher: '陈老师', sourceFileName: '演示课表.pdf', createdAt: timestamp(), updatedAt: timestamp() },
  ]
