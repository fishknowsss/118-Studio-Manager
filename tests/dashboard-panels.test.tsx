...
describe('dashboard panels', () => {
  ...
  it('keeps desktop dashboard sections inside a single viewport frame', () => {
    ...
    expect(styleSource).toMatch(/--dashboard-header-fit-h:\s*clamp\(52px,\s*8dvh,\s*76px\);/)
    expect(styleSource).toMatch(/\.app-shell\[data-view='dashboard'\] \.sidebar-brand\s*\{[\s\S]*height:\s*var\(--dashboard-header-fit-h\);/)
    expect(styleSource).toMatch(/--dash-header-fit-h:\s*var\(--dashboard-header-fit-h,\s*var\(--header-h\)\);/)
