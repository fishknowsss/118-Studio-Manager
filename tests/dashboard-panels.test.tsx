...
describe('dashboard panels', () => {
  ...
  it('keeps desktop dashboard sections inside a single viewport frame', () => {
    ...
    expect(styleSource).toMatch(/--app-header-fit-h:\s*clamp\(52px,\s*8dvh,\s*76px\);/)
    expect(styleSource).toMatch(/\.app-shell \.sidebar-brand\s*\{[\s\S]*height:\s*var\(--app-header-fit-h\);/)
    expect(styleSource).toMatch(/--dash-header-fit-h:\s*var\(--app-header-fit-h,\s*var\(--header-h\)\);/)
